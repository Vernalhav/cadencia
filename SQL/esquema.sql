...
CREATE TABLE HORA_DISP(
    ...
    CONSTRAINT FK_DISP_PROF FOREIGN KEY (professor) REFERENCES PROFESSOR(nome_login) ON DELETE CASCADE,
...
CREATE TABLE INSTRUMENTOS_TOCADOS(
    ...
    CONSTRAINT FK_TOCADOS_PROF FOREIGN KEY (professor) REFERENCES PROFESSOR(nome_login) ON DELETE CASCADE,
...
CREATE TABLE AULA(
    ...
    CONSTRAINT FK_AULA_TIPO_INST FOREIGN KEY (instrumento) REFERENCES CLASSIFICACAO_INSTRUMENTO(instrumento) ON DELETE SET NULL,
...
CREATE TABLE INSTRUMENTO(
    ...
    CONSTRAINT FK_INST_PROP FOREIGN KEY (proprietario) REFERENCES PROPRIETARIO(nome_login) ON DELETE CASCADE,

    CONSTRAINT PK_INSTRUMENTO PRIMARY KEY (nome, proprietario),

    tipo VARCHAR2(30) NOT NULL,
    
    CONSTRAINT FK_INST_TIPO FOREIGN KEY (tipo) REFERENCES CLASSIFICACAO_INSTRUMENTO(instrumento) ON DELETE SET NULL,
